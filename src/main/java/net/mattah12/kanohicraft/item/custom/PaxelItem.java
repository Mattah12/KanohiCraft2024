...
public class PaxelItem extends DiggerItem {
    protected static final Map<Block, Block> STRIPPABLES = new ImmutableMap.Builder<Block, Block>()
            ...
            .put(ModBlocks.VUATA_MACA_LOG.get(), ModBlocks.VUATA_MACA_STRIPPED_LOG.get())
            .put(ModBlocks.VUATA_MACA_LOG_COVERED.get(), ModBlocks.VUATA_MACA_STRIPPED_LOG.get())
            .put(ModBlocks.VUATA_MACA_LOG_HALF_COVERED.get(), ModBlocks.VUATA_MACA_STRIPPED_LOG.get())
            .put(ModBlocks.VUATA_MACA_WOOD.get(), ModBlocks.VUATA_MACA_STRIPPED_WOOD.get())
            .build();
